...
class Settings(context: Context) {
    ...
    /**
     * How many icons the dock fits, 1-5. Unrelated to the page grid's own
     ...
     * size this app shipped with; other counts scale from it.
     */
    var dockIconCount: Int
        get() = prefs.getInt(KEY_DOCK_COUNT, 4)
        set(value) = prefs.edit { putInt(KEY_DOCK_COUNT, value.coerceIn(1, 5)) }
